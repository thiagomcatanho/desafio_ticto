...
<nav class="relative bg-gray-800">
            ...
            <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                ...
                <el-dropdown class="relative ml-3">
                    ...
                    <el-menu anchor="bottom end" popover
                        ...
                        <a href="{{route('me.edit_password')}}"
                            class="block px-4 py-2 text-sm text-gray-700 focus:bg-gray-100 focus:outline-hidden">Alterar
                            Senha</a>
                        @endif
                        <a href="{{ route('auth.logout') }}"
                            class="block px-4 py-2 text-sm text-gray-700 focus:bg-gray-100 focus:outline-hidden">Sair</a>
                    </el-menu>
                </el-dropdown>
            </div>
        </div>
    ...
    @include('layouts.partials.menu_mobile')
</nav>
